...
export const DOCUMENTS = [
  {
    ...
    body: `
      ...
      <p>My music lives here — a place you have to choose to come to. That's on purpose. In a world that gives everything away for free and leaves you feeling nothing, I'd rather make something you have to mean.</p>
